...
public class Enquiry extends Fragment {
    ...
    public static Enquiry newInstance(String param1, String param2) {
        Enquiry fragment = new Enquiry();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root=inflater.inflate(R.layout.fragment_enquiry, container, false);

        n1=root.findViewById(R.id.fullname);
        n2=root.findViewById(R.id.signemailid);
        n3=root.findViewById(R.id.contactno);
        n4=root.findViewById(R.id.crs);
        n5=root.findViewById(R.id.selectcourse);

        Button btk=root.findViewById(R.id.sign_login2);
